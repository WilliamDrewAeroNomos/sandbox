 ...
 */
public class HeartbeatConfigurationDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.aeronomos.model.configuration.HeartbeatConfigurationDocument
{
    ...
    private static final javax.xml.namespace.QName HEARTBEATCONFIGURATION$0 = 
        new javax.xml.namespace.QName("http://model.aeronomos.com/configuration", "heartbeat-configuration");
    
    
    /**
     * Gets the "heartbeat-configuration" element
     */
    public com.aeronomos.model.configuration.HeartbeatConfigurationDocument.HeartbeatConfiguration getHeartbeatConfiguration()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.aeronomos.model.configuration.HeartbeatConfigurationDocument.HeartbeatConfiguration target = null;
            target = (com.aeronomos.model.configuration.HeartbeatConfigurationDocument.HeartbeatConfiguration)get_store().find_element_user(HEARTBEATCONFIGURATION$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setHeartbeatConfiguration(com.aeronomos.model.configuration.HeartbeatConfigurationDocument.HeartbeatConfiguration heartbeatConfiguration)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.aeronomos.model.configuration.HeartbeatConfigurationDocument.HeartbeatConfiguration)get_store().add_element_user(HEARTBEATCONFIGURATION$0);
            }
     ...
     */
    public com.aeronomos.model.configuration.HeartbeatConfigurationDocument.HeartbeatConfiguration addNewHeartbeatConfiguration()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class HeartbeatConfigurationImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.aeronomos.model.configuration.HeartbeatConfigurationDocument.HeartbeatConfiguration
    {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName INTERVALBETWEENBEATSMSECS$0 = 
            new javax.xml.namespace.QName("http://model.aeronomos.com/configuration", "interval-between-beats-msecs");
        private static final javax.xml.namespace.QName GENERATEHEARTBEAT$2 = 
            new javax.xml.namespace.QName("http://model.aeronomos.com/configuration", "generate-heartbeat");
