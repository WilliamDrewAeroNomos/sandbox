 ...
 */
package com.aeronomos.model.configuration.impl;
/**
 * A document containing one messaging-configuration(@http://model.aeronomos.com/configuration) element.
 *
 * This is a complex type.
 */
public class MessagingConfigurationDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.aeronomos.model.configuration.MessagingConfigurationDocument
{
    ...
    private static final javax.xml.namespace.QName MESSAGINGCONFIGURATION$0 = 
        new javax.xml.namespace.QName("http://model.aeronomos.com/configuration", "messaging-configuration");
    
    
    /**
     * Gets the "messaging-configuration" element
     */
    public com.aeronomos.model.configuration.MessagingConfigurationDocument.MessagingConfiguration getMessagingConfiguration()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.aeronomos.model.configuration.MessagingConfigurationDocument.MessagingConfiguration target = null;
            target = (com.aeronomos.model.configuration.MessagingConfigurationDocument.MessagingConfiguration)get_store().find_element_user(MESSAGINGCONFIGURATION$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setMessagingConfiguration(com.aeronomos.model.configuration.MessagingConfigurationDocument.MessagingConfiguration messagingConfiguration)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.aeronomos.model.configuration.MessagingConfigurationDocument.MessagingConfiguration)get_store().add_element_user(MESSAGINGCONFIGURATION$0);
            }
     ...
     */
    public com.aeronomos.model.configuration.MessagingConfigurationDocument.MessagingConfiguration addNewMessagingConfiguration()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class MessagingConfigurationImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.aeronomos.model.configuration.MessagingConfigurationDocument.MessagingConfiguration
    {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName MESSAGINGPORT$0 = 
            new javax.xml.namespace.QName("http://model.aeronomos.com/configuration", "messaging-port");
        private static final javax.xml.namespace.QName MESSAGINGTRANSPORT$2 = 
            new javax.xml.namespace.QName("http://model.aeronomos.com/configuration", "messaging-transport");
        private static final javax.xml.namespace.QName MESSAGINGHOST$4 = 
            new javax.xml.namespace.QName("http://model.aeronomos.com/configuration", "messaging-host");
